...
public class CloudController : MonoBehaviour
{
    ...
    void Start()
    {
        // Get Hold of the particle system
        cloudSystem = this.GetComponent<ParticleSystem>();
        Spawn(); // Method to add extra bits of code after the cloud has already been spawned.
    }

    void Spawn()
    {
        // extend the range of the scale on eiter side of the manager centre
